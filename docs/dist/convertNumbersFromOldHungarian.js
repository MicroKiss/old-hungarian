...
function convertNumbersAdditively(match) {
    let num = 0;
...
function convertNumbersMultiplicatively(match) {
    let num = 0;
...
export function convertNumbersFromOldHungarian(text, format) {
...
//# sourceMappingURL=convertNumbersFromOldHungarian.js.map