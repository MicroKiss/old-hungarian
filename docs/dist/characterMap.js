...
export const oldHungarianCharacters = [
...
export const alternativeK = { latin: 'k', small: '𐳔', large: '𐲔' };
// Alternative variant for 'ö'
export const alternativeO = { latin: 'ö', small: '𐳞', large: '𐲞' };
...
export function createCharacterMaps(useAltK, useAltO) {
...
export function getLatinToOldHungarianMaps(useAltK, useAltO) {
    if (!useAltK && !useAltO) {
        return defaultMaps;
    }
...
//# sourceMappingURL=characterMap.js.map