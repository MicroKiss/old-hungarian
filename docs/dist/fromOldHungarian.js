...
function convertDoubleCharactersFromOldHungarian(text, doubleMap) {
    let result = '';
...
function convertSingleCharactersFromOldHungarian(text, singleMap) {
    let result = '';
...
export function fromOldHungarian(text, options) {
...
//# sourceMappingURL=fromOldHungarian.js.map